...
400002b  add     r10, r11
400002e  mov     r10, qword ptr [r10+r8] ; {UncontrolledLoad@0x4000021, Attacker@0x4000000, Attacker@r11} -> HALF GADGET
4000032  ret     

------------------------------------------------
uuid: 11e1b88d-b32f-4079-a498-0b716ee6b12c

Expr: <BV64 LOAD_64[<BV64 LOAD_64[<BV64 0x2ac80 + gs>]_21>]_27 + (0#56 .. r11[7:0]) + (0#56 .. LOAD_8[<BV64 rdi>]_20)>
Base: <BV64 LOAD_64[<BV64 LOAD_64[<BV64 0x2ac80 + gs>]_21>]_27>
Attacker: <BV64 (0#56 .. r11[7:0]) + (0#56 .. LOAD_8[<BV64 rdi>]_20)>
