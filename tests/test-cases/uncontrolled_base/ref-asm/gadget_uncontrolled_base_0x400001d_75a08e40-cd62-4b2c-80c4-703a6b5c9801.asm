...
400001a  add     r9, rbx
400001d  mov     r9, qword ptr [r9+r8] ; {Attacker@rbx, Secret@0x4000000, UncontrolledLoad@0x4000017} -> TRANSMISSION
...
------------------------------------------------
uuid: 75a08e40-cd62-4b2c-80c4-703a6b5c9801
...
Register Requirements: ['<BV64 gs>', '<BV64 rbx>', '<BV64 rdi>']
Constraints: []
Branches: []
------------------------------------------------
