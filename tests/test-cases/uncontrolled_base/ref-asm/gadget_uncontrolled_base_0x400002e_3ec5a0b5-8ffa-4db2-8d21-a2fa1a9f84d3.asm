...
400002b  add     r10, r11
400002e  mov     r10, qword ptr [r10+r8] ; {Secret@0x4000000, UncontrolledLoad@0x4000021, Attacker@r11} -> TRANSMISSION
4000032  ret     

------------------------------------------------
uuid: 3ec5a0b5-8ffa-4db2-8d21-a2fa1a9f84d3
...
Register Requirements: {<BV64 rdi>, <BV64 gs>, <BV64 r11>}
Constraints: []
Branches: []
------------------------------------------------
