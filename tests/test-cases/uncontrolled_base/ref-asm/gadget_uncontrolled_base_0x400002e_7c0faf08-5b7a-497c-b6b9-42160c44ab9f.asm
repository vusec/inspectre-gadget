...
400002b  add     r10, r11
400002e  mov     r10, qword ptr [r10+r8] ; {UncontrolledLoad@0x4000021, Secret@0x4000000, Attacker@r11} -> TRANSMISSION
4000032  ret     

------------------------------------------------
uuid: 7c0faf08-5b7a-497c-b6b9-42160c44ab9f
...
Register Requirements: {<BV64 rdi>, <BV64 r11>, <BV64 gs>}
Constraints: []
Branches: []
------------------------------------------------
