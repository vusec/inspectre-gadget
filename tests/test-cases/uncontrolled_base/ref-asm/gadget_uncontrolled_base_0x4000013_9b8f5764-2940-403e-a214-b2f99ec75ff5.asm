...
4000013  mov     rdx, qword ptr [rdx+r8] ; {Secret@0x4000000, UncontrolledLoad@0x4000010} -> TRANSMISSION
...
------------------------------------------------
uuid: 9b8f5764-2940-403e-a214-b2f99ec75ff5
...
Register Requirements: ['<BV64 gs>', '<BV64 rdi>']
Constraints: []
Branches: []
------------------------------------------------
