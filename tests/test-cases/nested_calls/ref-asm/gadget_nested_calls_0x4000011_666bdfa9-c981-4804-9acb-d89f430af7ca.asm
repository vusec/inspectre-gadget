...
------------------------------------------------
uuid: 666bdfa9-c981-4804-9acb-d89f430af7ca
...
Constraints: []
Branches: [('0x4000000', '<Bool True>', 'Taken'), ('0x4000005', '<Bool True>', 'Taken'), ('0x400001d', '<Bool True>', 'Taken'), ('0x400001e', '<Bool True>', 'Taken')]
------------------------------------------------
