...
4000012  mov     eax, dword ptr [rax+rdi] ; {Attacker@rax, Attacker@0x4000000} -> HALF GADGET
4000015  jmp     0x400dead

------------------------------------------------
uuid: a851b875-c8bd-456d-ad31-085f04f74c7e

Expr: <BV64 rax + LOAD_64[<BV64 rdx + 0x18>]_20>
Base: None
Attacker: <BV64 rax + LOAD_64[<BV64 rdx + 0x18>]_20>
