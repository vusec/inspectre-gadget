...
------------------------------------------------
uuid: 4b333155-99d4-431e-a74d-3a3cd426a026
...
Constraints: []
Branches: [(67108875, <Bool (0#48 .. LOAD_16[<BV64 rdi>]_20) <= 0xffff>, 'Not Taken'), (67108891, <Bool (0x0 .. LOAD_16[<BV64 rdi>]_20) <= 0xff>, 'Not Taken')]
------------------------------------------------
