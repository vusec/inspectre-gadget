...
------------------------------------------------
uuid: c08453c9-3190-4f06-bbad-4a4225f76362

Secret Address:
  - Expr: <BV64 rdi + 0x7c>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 ((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x2) << 0x1)) << 0x6)>
...
Transmission:
  - Expr: <BV64 0xf44 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_53) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
