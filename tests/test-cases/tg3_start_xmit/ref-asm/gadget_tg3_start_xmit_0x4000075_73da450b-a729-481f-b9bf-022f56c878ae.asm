...
------------------------------------------------
uuid: 73da450b-a729-481f-b9bf-022f56c878ae
...
Transmission:
  - Expr: <BV64 0xc88 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True

Register Requirements: {<BV64 rsi>, <BV64 rdi>}
Constraints: [('0x400006d', <Bool ((0 .. LOAD_64[<BV64 rsi + 0x1b58>]_31[63:61]) & 1) != 0>), ('0x4000075', <Bool ((0 .. LOAD_64[<BV64 rsi + 0x1b58>]_162[63:61]) & 1) == 0>)]
Branches: []
------------------------------------------------
