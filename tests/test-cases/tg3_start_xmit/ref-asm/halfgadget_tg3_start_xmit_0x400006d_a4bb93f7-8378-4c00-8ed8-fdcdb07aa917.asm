...
400006d  mov     esi, dword ptr [r12+0x240] ; {Attacker@0x4000029, Attacker@rsi} -> HALF GADGET
...
------------------------------------------------
uuid: a4bb93f7-8378-4c00-8ed8-fdcdb07aa917

Expr: <BV64 0xf40 + rsi + (((0#6 .. (0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_28)) << 0x6) + ((0#6 .. ((0#1 .. (0#41 .. LOAD_16[<BV64 rdi + 0x7c>]_28)) << 0x1) + ((0#1 .. (0#39 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_28) << 0x2)) << 0x1)) << 0x6))>
Base: <BV64 0xf40>
