...
------------------------------------------------
uuid: 63f7c36e-c925-47c3-9761-a43b1b716a88
...
Transmission:
  - Expr: <BV64 0xf48 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_40) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_40) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_40) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
