...
40000a0  add     rax, rdi
40000a3  movzx   ecx, byte ptr [rax+0x2] ; {Attacker@0x400007d, Secret@0x4000095} > TRANSMISSION
40000a7  add     ecx, 0x1
40000aa  cmp     ecx, edx
40000ac  jmp     0x400dead

------------------------------------------------
uuid: aaf20a86-a756-4df3-8fc2-fe94e199dc07

Secret Address:
  - Expr: <BV64 rdi + 0xc0>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 0#32 .. LOAD_32[<BV64 rdi + 0xc0>]_267>
  - Range: (0x0,0xffffffff, 0x1) Exact: True
  - Spread: 0 - 31
  - Number of Bits Inferable: 32
Base:
  - Expr: <BV64 0x2 + LOAD_64[<BV64 rdi + 0xc8>]_265>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
  - Independent Expr: <BV64 0x2>
  - Independent Range: 0x2
Transmission:
  - Expr: <BV64 0x2 + (0#32 .. LOAD_32[<BV64 rdi + 0xc0>]_267) + LOAD_64[<BV64 rdi + 0xc8>]_265>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
