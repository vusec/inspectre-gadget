...
------------------------------------------------
uuid: 71c29f1a-d07d-4a88-87b4-9cecef8c6b2b

Secret Address:
  - Expr: <BV64 rdi + 0xc0>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 0#32 .. LOAD_32[<BV64 rdi + 0xc0>]_248>
  - Range: (0x0,0xffffffff, 0x1) Exact: True
  - Spread: 0 - 31
  - Number of Bits Inferable: 32
Base:
  - Expr: <BV64 0x2 + LOAD_64[<BV64 rdi + 0xc8>]_246>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
  - Independent Expr: <BV64 0x2>
  - Independent Range: 0x2
Transmission:
  - Expr: <BV64 0x2 + (0#32 .. LOAD_32[<BV64 rdi + 0xc0>]_248) + LOAD_64[<BV64 rdi + 0xc8>]_246>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
