...
4000075  mov     edx, dword ptr [r12+0x248] ; {Secret@0x4000029, Attacker@rsi} > TRANSMISSION
...
------------------------------------------------
uuid: 69ed5f2a-8b3b-41af-a9dd-bd012cb18a90

Secret Address:
  - Expr: <BV64 rdi + 0x7c>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 ((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x2) << 0x1)) << 0x6)>
...
Transmission:
  - Expr: <BV64 0xf48 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_159) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
