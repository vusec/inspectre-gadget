...
400001c  mov     esi, edi
400001e  add     rsi, qword ptr [r12+0x20] ; {Attacker@r12} -> {Attacker@0x400001e}
4000023  mov     rax, qword ptr [r12+0x28] ; {Attacker@r12} -> {Secret@0x4000023}
4000028  mov     r11, qword ptr [rsi+rax] ; {Attacker@0x400001e, Attacker@rdi, Secret@0x4000023} -> TRANSMISSION
400002c  jmp     0x400dead

------------------------------------------------
uuid: 0e17c5fb-1aac-4225-8d6f-40524fe13428
...
Transmitted Secret:
  - Expr: <BV64 LOAD_64[<BV64 r12 + 0x28>]_25>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
  - Spread: 0 - 63
  - Number of Bits Inferable: 64
Base:
  - Expr: <BV64 (0#32 .. rdi[31:0]) + LOAD_64[<BV64 r12 + 0x20>]_24>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
