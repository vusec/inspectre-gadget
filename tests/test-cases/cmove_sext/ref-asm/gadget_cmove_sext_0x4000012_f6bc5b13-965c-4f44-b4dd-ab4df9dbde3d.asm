...
------------------------------------------------
uuid: f6bc5b13-965c-4f44-b4dd-ab4df9dbde3d
...
Constraints: [('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>', 'ConditionType.SIGN_EXT'), ('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>', 'ConditionType.SIGN_EXT'), ('0x400000c', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20 != 0x0>', 'ConditionType.CMOVE')]
Branches: []
------------------------------------------------
