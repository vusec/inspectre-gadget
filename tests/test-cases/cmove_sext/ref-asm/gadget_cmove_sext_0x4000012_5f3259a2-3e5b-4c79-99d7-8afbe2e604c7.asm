...
------------------------------------------------
uuid: 5f3259a2-3e5b-4c79-99d7-8afbe2e604c7
...
Constraints: [('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>', 'ConditionType.SIGN_EXT'), ('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>', 'ConditionType.SIGN_EXT'), ('0x400000c', '<Bool (0x0 .. LOAD_32[<BV64 rdx + 0x18>]_20) == 0x0>', 'ConditionType.CMOVE')]
Branches: []
------------------------------------------------
