...
------------------------------------------------
uuid: 8904a88f-4e98-4821-acd6-f5a4e4a72d5b
...
Constraints: [('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] != 0>', 'ConditionType.SIGN_EXT'), ('0x4000003', '<Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] != 0>', 'ConditionType.SIGN_EXT'), ('0x400000c', '<Bool (0xffffffff .. LOAD_32[<BV64 rdx + 0x18>]_20) != 0x0>', 'ConditionType.CMOVE')]
Branches: []
------------------------------------------------
