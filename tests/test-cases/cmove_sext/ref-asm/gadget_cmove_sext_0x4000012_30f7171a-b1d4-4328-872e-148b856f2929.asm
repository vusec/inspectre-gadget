...
------------------------------------------------
uuid: 30f7171a-b1d4-4328-872e-148b856f2929
...
Constraints: [('0x4000003', <Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>, 'ConditionType.SIGN_EXT'), ('0x400000c', <Bool (0x0 .. LOAD_32[<BV64 rdx + 0x18>]_20) == 0x0>, 'ConditionType.CMOVE'), ('0x4000003', <Bool LOAD_32[<BV64 rdx + 0x18>]_20[31:31] == 0>, 'ConditionType.SIGN_EXT')]
Branches: []
------------------------------------------------
