...
400000d  mov     rax, qword ptr [rdx+0x20] ; {Attacker@rdx} -> {Secret@0x400000d}
4000011  mov     rcx, qword ptr [rax] ; {Secret@0x400000d} -> TRANSMISSION
...
------------------------------------------------
uuid: 67ad0cca-9d9b-45b2-bfbb-93c1950489f2
