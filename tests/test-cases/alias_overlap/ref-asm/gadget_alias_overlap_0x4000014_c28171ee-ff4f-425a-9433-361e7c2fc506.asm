...
4000006  nop     
4000007  nop     
4000008  movzx   r8d, word ptr [rdx+0x28] ; {Attacker@rdx} -> {Attacker@0x4000008}
400000d  mov     rax, qword ptr [rdx+0x20] ; {Attacker@rdx} -> {Attacker@0x400000d}
4000011  mov     rcx, qword ptr [rax] ; {Attacker@0x400000d} -> {Secret@0x4000011}
4000014  mov     r11, qword ptr [rcx+r8] ; {Attacker@0x4000008, Secret@0x4000011} -> TRANSMISSION
...
------------------------------------------------
uuid: c28171ee-ff4f-425a-9433-361e7c2fc506
