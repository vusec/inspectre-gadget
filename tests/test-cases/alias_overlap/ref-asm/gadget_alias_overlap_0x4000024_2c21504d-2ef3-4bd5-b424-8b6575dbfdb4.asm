...
4000018  movzx   r9d, word ptr [rdx+0x24] ; {Attacker@rdx} -> {Secret@0x4000018}
400001d  mov     rbx, qword ptr [rdx+0x20] ; {Attacker@rdx} -> {Attacker@0x400001d}
4000021  mov     rsi, qword ptr [rbx] ; {Attacker@0x400001d} -> {Attacker@0x4000021}
4000024  mov     r12, qword ptr [rsi+r9] ; {Attacker@0x4000021, Secret@0x4000018} -> TRANSMISSION
4000028  jmp     0x400dead

------------------------------------------------
uuid: 2c21504d-2ef3-4bd5-b424-8b6575dbfdb4
