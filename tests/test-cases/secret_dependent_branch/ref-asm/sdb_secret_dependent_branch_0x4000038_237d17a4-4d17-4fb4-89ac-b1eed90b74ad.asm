...
4000026  je      end ; Not Taken   <Bool (0#48 .. LOAD_16[<BV64 rdi + 0x20>]_23) != rdi>
         t3:
4000028  mov     rax, qword ptr [0xffffffff81000000] ; {} -> {UncontrolledLoad@0x4000028}
4000030  movzx   r9, word ptr [rdi+0x30] ; {Attacker@rdi} -> {Secret@0x4000030}
4000035  cmp     r9, rax
4000038  je      end ; {Secret@0x4000030, UncontrolledLoad@0x4000028} -> SECRET DEPENDENT BRANCH

------------------------------------------------
uuid: 237d17a4-4d17-4fb4-89ac-b1eed90b74ad
