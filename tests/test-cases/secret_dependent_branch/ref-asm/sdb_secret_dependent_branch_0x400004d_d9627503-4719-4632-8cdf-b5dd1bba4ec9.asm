...
4000038  je      end ; Not Taken   <Bool (0#48 .. LOAD_16[<BV64 rdi + 0x30>]_25) != LOAD_64[<BV64 0xffffffff81000000>]_24>
         t4:
400003a  mov     rax, qword ptr [0xffffffff81000000] ; set() -> {UncontrolledLoad@0x400003a}
4000042  movzx   r9, word ptr [rdi+0x30] ; {Attacker@rdi} -> {Secret@0x4000042}
4000047  add     r9, rax
400004a  cmp     r9, rsi
400004d  je      end ; {UncontrolledLoad@0x400003a, Secret@0x4000042, Attacker@rsi} -> SECRET DEPENDENT BRANCH

------------------------------------------------
uuid: d9627503-4719-4632-8cdf-b5dd1bba4ec9
