...
------------------------------------------------
uuid: 435389b3-daa7-4dfe-914c-000168c41265
...
Controlled Regs:
  - Reg: rax
    Expr: <BV64 0x0 .. LOAD_16[<BV64 rdi>]_22>
    ControlType: TFPRegisterControlType.INDIRECTLY_DEPENDS_ON_TFP_EXPR
    Controlled Expr: <BV64 0#48 .. LOAD_16[<BV64 rdi>]_22>
  ...
  - Reg: r8
    ...
    Controlled Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
    Controlled Range w Branches:0x1
  - Reg: r9
    Expr: <BV64 r9>
    ControlType: TFPRegisterControlType.UNMODIFIED
