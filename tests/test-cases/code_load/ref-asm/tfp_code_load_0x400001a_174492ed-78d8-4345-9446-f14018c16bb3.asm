...
------------------------------------------------
uuid: 174492ed-78d8-4345-9446-f14018c16bb3
...
Controlled Regs:
  - Reg: rax
    Expr: <BV64 rdx + (0x0 .. LOAD_16[<BV64 rdi>]_20)>
    ControlType: TFPRegisterControlType.IS_TFP_REGISTER
    Controlled Expr: <BV64 rdx + (0#48 .. LOAD_16[<BV64 rdi>]_20)>
  ...
  - Reg: rdx
    Expr: <BV64 rdx>
    ControlType: TFPRegisterControlType.DEPENDS_ON_TFP_EXPR
    Controlled Expr: <BV64 rdx>
    Controlled Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
    Controlled Range w Branches:(0x0,0xffffffffffffffff, 0x1) Exact: True
  - Reg: rsi
    Expr: <BV64 0x0 .. LOAD_16[<BV64 rdi>]_20>
    ControlType: TFPRegisterControlType.DEPENDS_ON_TFP_EXPR
    Controlled Expr: <BV64 0#48 .. LOAD_16[<BV64 rdi>]_20>
    Controlled Range: (0x0,0xffff, 0x1) Exact: True
    Controlled Range w Branches:(0x0,0xffff, 0x1) Exact: True
  - Reg: rdi
    Expr: <BV64 rdi>
    ControlType: TFPRegisterControlType.UNMODIFIED
  ...
  - Reg: r8
    ...
    Controlled Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
    Controlled Range w Branches:(0x3,0xffffffffffffffff, 0x1) Exact: True
  - Reg: r9
    Expr: <BV64 r9>
    ControlType: TFPRegisterControlType.UNMODIFIED
...
Unmodified Regs: ['rbx', 'rcx', 'rdi', 'r8', 'r9', 'r10', 'r11', 'r12', 'r13', 'r14', 'r15', 'rsp_0', 'rsp_8', 'rsp_16', 'rsp_24', 'rsp_32', 'rsp_40', 'rsp_48', 'rsp_56', 'rsp_64', 'rsp_72', 'rsp_80', 'rsp_88', 'rsp_96', 'rsp_104', 'rsp_112', 'rsp_120', 'rsp_128', 'rsp_136', 'rsp_144', 'rsp_152']
Potential Secrets: []
