...
------------------------------------------------
uuid: a9395d84-b44f-4b26-b762-839faa5e55ca
...
Transmission:
  - Expr: <BV64 0xc84 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
