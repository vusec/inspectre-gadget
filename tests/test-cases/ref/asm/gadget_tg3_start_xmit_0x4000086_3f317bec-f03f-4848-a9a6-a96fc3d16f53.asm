...
4000084  mov     eax, esi
4000086  sub     eax, dword ptr [r12+0x244] ; {Secret@0x4000029, Attacker@rsi} > TRANSMISSION
...
------------------------------------------------
uuid: 3f317bec-f03f-4848-a9a6-a96fc3d16f53

Secret Address:
  - Expr: <BV64 rdi + 0x7c>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 ((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x2) << 0x1)) << 0x6)>
...
Base:
  - Expr: <BV64 0xf44 + rsi>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
  - Independent Expr: <BV64 0xf44 + rsi>
  - Independent Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmission:
  - Expr: <BV64 0xf44 + rsi + (((0#48 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x6) + ((0#6 .. ((0#42 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x1) + ((0#40 .. (0#2 .. LOAD_16[<BV64 rdi + 0x7c>]_225) << 0x2) << 0x1)) << 0x6))>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True

Register Requirements: {<BV64 rsi>, <BV64 rdi>}
Constraints: [('0x400006d', <Bool ((0 .. LOAD_64[<BV64 rsi + 0x1b58>]_31[63:61]) & 1) != 0>), ('0x4000075', <Bool ((0 .. LOAD_64[<BV64 rsi + 0x1b58>]_162[63:61]) & 1) != 0>), ('0x4000086', <Bool ((0 .. LOAD_64[<BV64 rsi + 0x1b58>]_228[63:61]) & 1) != 0>)]
Branches: []
------------------------------------------------
