...
------------------------------------------------
uuid: d0aabd44-5784-4848-9890-932241f53760

Secret Address:
  - Expr: <BV64 rsi>
  - Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
Transmitted Secret:
  - Expr: <BV64 0#47 .. LOAD_32[<BV64 rsi>]_20[16:0]>
  - Range: (0x0,0x1ffff, 0x1) Exact: True
  - Spread: 0 - 16
  - Number of Bits Inferable: 17
Base:
...
Transmission:
  - Expr: <BV64 0xffffffff81000000 + (0#47 .. LOAD_32[<BV64 rsi>]_20[16:0])>
  - Range: (0xffffffff81000000,0xffffffff8101ffff, 0x1) Exact: True
