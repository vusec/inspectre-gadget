...
------------------------------------------------
uuid: 2fa8aad1-0018-41fb-a608-ca13cf8fe349
...
Controlled Regs:
  ...
  - Reg: r10
    ...
    ControlType: TFPRegisterControlType.POTENTIAL_SECRET
    Controlled Expr: <BV64 LOAD_64[<BV64 rdi + 0xfffffffffffffff0>]_21>
    Controlled Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
    Controlled Range w Branches:(0x0,0xffffffffffffffff, 0x1) Exact: True
  - Reg: r11
    Expr: <BV64 LOAD_64[<BV64 LOAD_64[<BV64 rdi + 0xfffffffffffffff0>]_21>]_22>
    ControlType: TFPRegisterControlType.POTENTIAL_SECRET
    Controlled Expr: <BV64 LOAD_64[<BV64 LOAD_64[<BV64 rdi + 0xfffffffffffffff0>]_21>]_22>
    Controlled Range: (0x0,0xffffffffffffffff, 0x1) Exact: True
    Controlled Range w Branches:(0x0,0xffffffffffffffff, 0x1) Exact: True
  - Reg: r12
    Expr: <BV64 r12>
...
Unmodified Regs: ['rbx', 'rcx', 'rdx', 'rsi', 'rdi', 'r9', 'r12', 'r13', 'r14', 'r15', 'rsp_0', 'rsp_8', 'rsp_16', 'rsp_24', 'rsp_32', 'rsp_40', 'rsp_48', 'rsp_56', 'rsp_64', 'rsp_72', 'rsp_80', 'rsp_88', 'rsp_96', 'rsp_104', 'rsp_112', 'rsp_120', 'rsp_128', 'rsp_136', 'rsp_144', 'rsp_152']
