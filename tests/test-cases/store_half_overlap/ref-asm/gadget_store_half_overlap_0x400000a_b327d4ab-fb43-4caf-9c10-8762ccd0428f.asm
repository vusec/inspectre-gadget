...
400000a  mov     rdi, qword ptr [r11+rdi-0x7f000000] ; {Attacker@rsi, Uncontrolled@MEM_32[<BV64 r8> + 32]_21, Secret@0x4000006} -> TRANSMISSION
4000012  jmp     0x400dead

------------------------------------------------
uuid: b327d4ab-fb43-4caf-9c10-8762ccd0428f
...
Register Requirements: {<BV64 rsi>, <BV64 rdx>, <BV32 MEM_32[<BV64 r8> + 32]_21>}
Constraints: []
Branches: []
------------------------------------------------
